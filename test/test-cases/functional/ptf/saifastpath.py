...
# @use_flow
# class SaiThriftFastPathTest(SaiHelperSimplified):
#     """ Test saithrift vnet outbound towards dpapp"""

#     def setUp(self):
#         super(SaiThriftFastPathTest, self).setUp()
#         self.switch_id = 5
...
#         print("\tSending 1st outbound udp packet...")
#         send_packet(self, 0, vxlan_pkt)

#         print("\tSending 2nd outbound udp packet...")
#         send_packet(self, 0, vxlan_pkt)
...
#             super(SaiThriftFastPathTest, self).tearDown()
