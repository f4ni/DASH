...
class metering_update_stage:
    ...
    def apply(cls):
        ...
        if meta.meter_class == 0:
            py_log("info", "Lookup in 'meter_policy'")
            cls.meter_policy.apply()
            py_log("info", "Lookup in 'meter_rule'")
            cls.meter_rule.apply()

        py_log("info", "Lookup in 'meter_bucket'")
        ...
        py_log("info", "Lookup in 'eni_meter'")
        cls.eni_meter.apply()
