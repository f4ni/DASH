...
#     eni_id = 42
#     UPDATE_ENI_COUNTER("eni_rx", eni_id, 100)
#     UPDATE_ENI_COUNTER("eni_tx", eni_id, 95)
#     UPDATE_ENI_COUNTER("flow_created", eni_id, 1)

#     eni_id_2 = 199
#     UPDATE_ENI_COUNTER("eni_rx", eni_id_2, 100)
#     UPDATE_ENI_COUNTER("eni_tx", eni_id_2, 95)

#     # Print stats
#     DashCounters.print_stats()
