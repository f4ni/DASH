...
from call_graph import find_string_references
...
def make_vec_node(ctr_name: str) -> Optional[OrderedDict]:
    ...
    if ctr is None:
        print(f"⚠️ Counter '{ctr_name}' not found in DashCounters._counters")
        return None
