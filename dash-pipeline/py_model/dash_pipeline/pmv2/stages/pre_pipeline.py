...
from pmv2.dash_routing_types import *
...
class pre_pipeline_stage:
    ...
    def apply(cls):
            ...
            # elif (hdr.customer_ipv4.isValid()):
            ...
            py_log("info", "Lookup in 'appliance'")
            cls.appliance.apply()

            py_log("info", "Lookup in 'internal_config'")
