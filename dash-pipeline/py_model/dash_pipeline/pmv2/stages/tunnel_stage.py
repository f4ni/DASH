...
class tunnel_stage:
    ...
    @classmethod
    def apply(cls):
        py_log("info", "tunnel_stage called")
        if meta.dash_tunnel_id == 0:
            return

        py_log("info", "Lookup in 'tunnel'")
        cls.tunnel.apply()
        ...
        if meta.dash_tunnel_max_member_size > 1:
            ...
            py_log("info", "Lookup in 'tunnel_member_select'")
            cls.tunnel_member_select.apply()
            py_log("info", "Lookup in 'tunnel_member'")
            cls.tunnel_member.apply()
            py_log("info", "Lookup in 'tunnel_next_hop'")
            py_log("info", "Lookup in 'tunnel_next_hop'")
