...
from pmv2.dash_tunnel import *
from pmv2.dash_counters import *
from pmv2.dash_underlay import *
...
class dash_eni_stage:
    ...
    def set_eni_attrs(cps: Annotated[int, 32],
        ...
        # ha_scope_id = int(ha_scope_id, 16)
...
class dash_match_stage:
    ...
    def apply(cls):
        ...
        py_log("info", "Lookup in 'acl_group' ")
        cls.acl_group.apply()
...
class dash_ingress:
    ...
    def apply(cls):
        ...
        if meta.flow_enabled:
            ...
            py_log("info", "meta.to_dpapp:", meta.to_dpapp)
