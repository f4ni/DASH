...
# Wrapper
# ---------------------------
def generate_countergraph(project_dir: str, entry_file: str = "dash_pipeline.py", verbose=False) -> Tuple[list[str], list[str]]:
...
if __name__ == "__main__":
    project_dir = "./pmv2"
    chains, dir_chains = generate_countergraph(project_dir, entry_file="dash_pipeline.py")
